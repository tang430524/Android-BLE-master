...
public class DeviceInfoAdapter extends RecyclerView.Adapter<DeviceInfoAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int position) {
        ...
        viewHolder.tvServiceHandle.setText("Handle:"+gattService.getInstanceId());
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            tvServiceHandle = itemView.findViewById(R.id.tv_service_handle);
